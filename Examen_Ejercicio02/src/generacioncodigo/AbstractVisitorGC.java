...
public abstract class AbstractVisitorGC implements Visitor {
	...
	public Object visit(Lectura lectura, Object o) throws IllegalStateException {
		throw new IllegalStateException();
	}
	...
	public Object visit(SentenciaIf if1, Object o) throws IllegalStateException {
		throw new IllegalStateException();
	}
	...
	public Object visit(TipoError error, Object o) throws IllegalStateException {
		throw new IllegalStateException();
	}
	...
	@Override
	public Object visit(ListaExamen listaExamen, Object o)
			throws IllegalStateException {
		throw new IllegalStateException();
	}
