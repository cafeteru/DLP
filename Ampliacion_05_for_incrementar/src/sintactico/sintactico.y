...
incre: expresion AUMENTAR 																	            {  	LiteralEntero a = new LiteralEntero(lexico.getLine(), lexico.getColumn(), 1);
	 ...
	 | expresion DISMINUIR 																	            {  	LiteralEntero a = new LiteralEntero(lexico.getLine(), lexico.getColumn(), 1);
			 																								Aritmetica b = new Aritmetica(lexico.getLine(), lexico.getColumn(), (Expresion) $1, "-", a);	 
																											$$ = new Asignacion(lexico.getLine(), lexico.getColumn(), (Expresion) $1, b); 
																										}
	 ;
